...
<body>
    ...
    $query = "SELECT s.created_date, person_name, country, mobile, email, services_type, brands_name, models_name, urgent, upload_document, upload_picture, s.status, s.modified_date
              FROM user u
              ...
              ON u.user_id = s.user_id AND services_type_id = 2001
                ...
                <tbody>
                   ...
                   ?>
                    <tr>
                        ...
                        <td><?php echo $user['brands_name']; ?></td>
