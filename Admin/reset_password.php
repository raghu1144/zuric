...
<head>
    ...
    <meta charset="UTF-8" />
    <link rel="shortcut icon" href="./images/Transparent-Logo1.jpg">
    <!-- //Meta tag Keywords -->
        ...
        <div class="workinghny-form-grid">
            <div class="wrapper">
                <div class="logo" style="    margin-bottom: 61px;
                                              margin-top: -45px;">
                    <h1><a class="brand-logo" href="./index.php" style="height: 49px; width: auto; display: flex; justify-content: center;"><img src="./images/Transparent-Logo1.jpg"></a></h1>
                        ...
                        <div class="login-form-content">
                            ...
                            <input type="hidden" name="e" value="<?php echo $_GET['e']; ?>">
                                <div class="one-frm one-frm-update">
                                    <input type="text" name="Admin_Password" placeholder="" required="" autofocus>
                                </div>
