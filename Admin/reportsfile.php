...
<?php
    ...
    if ($services_type != "" && $toDate != "" && $fromDate != "") {
...
?>
    <section style="padding: 3px 15px;">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3">
                    <label for="choice">Select Task Reports:</label>
                ...
                <div class="col-md-3">
                    <div class="formgroup">
                        <label>To Date:</label>
                        <input name="toDate" style="width: 100%;" class="todate form-control" placeholder="DD/MM/YYYY"
