        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-header pb-0">
              <div class="d-lg-flex">
                <div>
                  <h5 class="mb-0" style="margin-left: -20px;"> Newsletters</h5>
            ...
            <div style="margin-top: 30px;">
              <form method="post">
                ...
                <input type="date" id="from" name="from" required value="">
                <label for="to">to</label>
                <input type="date" id="to" name="to" required value="">
                <input type="submit" name="filter" value="Filter" style="width: 90px; margin-left: 20px; background-color: #0e402d; color:#fff"> <form action="">
                  <button type="button" onclick="window.location.href='newsletter.csv'" style="margin-left: 20px; background-color:#0e402d; color:#fff;">Download</button>
                </form>
              </form>
            </div>
...
if (isset($_POST['filter'])) {
    ...
    $sql = "SELECT * FROM newsetller WHERE date(date) BETWEEN '$from' AND '$to'";
} else {
...
if ($result) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $emailId = $row['emailId'];
        $date = $row['date'];
        $data_for_file = $data_for_file . "$id,$emailId,$date\n";
        echo '<tr>
    <th scope="row">' . $id . '</th>
     <td>' . $emailId . '</td>
     <td> ' . $date . '</td>
...
$file = fopen("newsletter.csv", "w");
fwrite($file, $data_for_file);
fclose($file);
?>
                ...
                <!-- <form action="">
                  <button type="button" onclick="window.location.href='newsletter.csv'">Download</button>
                </form> -->
  </main>
