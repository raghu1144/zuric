            ...
            <li class="nav-item ">
              ...
              <li class="nav-item ">
                ...
                <box-icon name='group' color="white"  width="25px;" height="20px"></box-icon>  
                  <span class="sidenav-normal  ms-2  ps-1"> HR <b class="caret"></b></span>
                </a>
                  ...
                  <ul class="nav nav-sm flex-column">
                    <li class="nav-item">
                      <a class="nav-link text-white " href="../Products/newsletter.php">
                        ...
                        <span class="sidenav-normal  ms-2  ps-1"> HR </span>
                      </a>
                    </li>
<!--
                    <li class="nav-item">
              ...
              <li class="nav-item ">
                ...
                <span class="sidenav-normal  ms-2  ps-1"> Mobile APP <b class="caret"></b></span>
                </a>
                <div class="collapse " id="profileExample">
                  <ul class="nav nav-sm flex-column">
                    <li class="nav-item">
                      ...
                      <box-icon name='mobile' color="white"></box-icon>
                        <span class="sidenav-normal  ms-2  ps-1"> Mobile APP  </span>
                      </a>
                    </li>
                    <!-- <li class="nav-item">
                      <a class="nav-link text-white " href="../../../pages/pages/profile/projects.html">
              ...
              <div class="d-lg-flex">
                ...
                <div class="ms-auto my-auto mt-lg-0 mt-4">
                  <div class="ms-auto my-auto">
                    <a href="../Products/NewProduct.php" class="btn bg-gradient-primary btn-sm mb-0" target="_blank">+&nbsp; New Product</a>
  ...
  <thead>
    <tr>
      ...
      <th scope="col"><span style="margin-left: 50px;">Action</span></th>
...
if ($result) {
    ...
    <th scope="row">' . $serial_no . '</th>
     ...
     <td>' . $stock . '</td>
     <td>
     <button class="btn btn-primary" style="background-color: #0e402d"><a href="EditProduct.php? updateserial_no=' . $serial_no . '" class="text-light">Update</a></button>
     <button class="btn btn-danger"><a href="delete.php? deleteserial_no=' . $serial_no . '" class="text-light">Delete</a></button>
     </td>
