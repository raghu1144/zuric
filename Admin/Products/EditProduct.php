        ...
        <div class="col-lg-4">
          <div class="card mt-4">
            <div class="card-header p-0  mt-n4 mx-3 z-index-2">
              <a class="d-block">
              <img src="data:image/png;charset=utf8;base64,<?php echo base64_encode($rows['product_image']); ?>" alt="img-blur-shadow" class="img-fluid shadow border-radius-lg">
              </a>
            ...
            <div class="card-body">
              ...
              <div class="col-4">
                <select class="form-control" name="choices-sizes" id="choices-currency-edit">
                  <option value="Choice 1" selected="" name="currency">USD</option>
              ...
              <div class="col-5">
                <div class="input-group input-group-dynamic">
                  ...
                  <input type="text" class="form-control w-100" aria-describedby="emailHelp" onfocus="focused(this)" onfocusout="defocused(this)" name="sku" value="<?php echo $sku; ?>">
                </div>
              </div>
            </div>
            <div class="row">
