...
<body>
    ...
    $query = "SELECT s.created_date, s.modified_date, person_name, country, mobile, email, services_type, brands_name, models_name, urgent, upload_document, upload_picture, s.status
              FROM user u
              ...
              ON u.user_id = s.user_id AND services_type_id = 2002
