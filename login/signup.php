                ...
                <div class="workinghny-block-grid">
                    <div class="form-right-inf">
                        ...
                        <div class="login-form-content">
                            ...
                            <form action="signup_script.php" class="signin-form" method="post">
                                <h4 style="text-align: left;margin-left: 1px; padding-bottom: 3px;">Full Name</h4>
                                <div class="one-frm">
                                    <input  name="name" placeholder="" required="" autofocus>
                                </div>
                                <h4 style="text-align: left;margin-left: 1px; padding-bottom: 3px;">Email</h4>
                                <div class="one-frm">
                                    <input type="email" name="email" placeholder="" required="" autofocus>
                                </div>
                                <h4 style="text-align: left;margin-left: 1px; padding-bottom: 3px;">Mobile Number</h4>

<!--
                                <div class="one-frm pd-telephone-input">
                                    <input type="tel" id= "" name="mobilepicker" class="form-control " placeholder="" required="" autofocus>
                                </div> -->


                                <div class="one-frm" style="display: flex;">
                        ...
                        background:#e7e9ec">
                          ...
                          <option data-calling-code="358" data-country-code="AX" value="AX" data-a-html-content="Åland Islands +358">
                            ...
                            AX +358
                                ...
                                <div><input type="number" style="    width: 119%;" name="mobile" placeholder="Phone" required="" autofocus></div>
                                </div>
                                <h4 style="text-align: left;margin-left: 1px;padding-bottom: 3px;">Password</h4>
                                <div class="one-frm">
                                    <input type="password" name="password" placeholder="" required="">
                                </div>
                                <h4 style="text-align: left; margin-left: 1px; padding-bottom: 3px;">Comfirm Password</h4>
                                <div class="one-frm">
                                    <input type="password" name="comfirm_password" placeholder="" required="">
                                </div>
                                <input class="btn btn-style mt-3" type="submit" value="Sign up" >
        ...
        <div class="copyright text-center">
            <div class="wrapper">
                <p  style="margin-top: -31px;" class="copy-footer-29"><b style="font-size: 15px;">© 2022 Primo. Privacy policy</b></p>
            </div>
        </div>
        <!-- //copyright-->
    </section>
    <!-- //form section start -->
    <!-- <script src="./pidie.js"></script>
    <script>
        new Pidie();
    </script> -->
