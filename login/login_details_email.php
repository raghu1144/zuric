...
$id = $_GET['id'];
$sql = "SELECT email, password FROM signup WHERE id= '$id'";
                  ...
                  <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td class="content-cell">
                        <h1 style="text-align:center">Please note the login details.</h1>
                        <p style="text-align:center">Thank you for signing up for Primo! We are excited to have you.</p>
                        <!-- Action -->
                        <table class="body-action" align="center" width="100%" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="center">
                              <div>
                                <p style="text-align:center">Your username : <span><b><?php echo $email ?></b> </span></p>
                                <p style="text-align:center">Password : <b><?php echo $password ?></b></p>
                              </div>
                            </td>
                          </tr>
                        </table>
